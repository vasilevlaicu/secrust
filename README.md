...
3. Install `secrust` pre-release using Cargo:
   ```bash
   cargo install secrust --version 0.1.0-alpha.2
   ```
...
*Figure: CFG generated by Secrust that was manually highlighted to show all basic paths extracted by Secrust. Secrust will also save each basic path in a separate .DOT file*
